...
var CreateTransactionService = /** @class */ (function () {
    ...
    CreateTransactionService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var transactionsRepository, categoriesRepository, total, transactionCategory, transaction;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, typeorm_1.getCustomRepository(TransactionsRepository_1.default).getBalance()];
                    case 1:
                        total = (_b.sent()).total;
                        if (type !== 'income' && type !== 'outcome') {
                            throw new AppError_1.default('Type is invalid!');
                        }
                        if (type === 'outcome' && value > total) {
                            throw new AppError_1.default('Can not outcome transaction without a valid balance');
                        }
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, categoriesRepository.save(transactionCategory)];
                    case 3:
                        _b.sent();
                        _b.label = 4;
                    case 4:
                    ...
                    case 5:
                        _b.sent();
                        return [2 /*return*/, __assign(__assign({}, transaction), { category: transactionCategory })];
                }
            });
        });
    };

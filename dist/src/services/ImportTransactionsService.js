...
var ImportTransactionsService = /** @class */ (function () {
    ...
    ImportTransactionsService.prototype.execute = function (filePath) {
        return __awaiter(this, void 0, void 0, function () {
            var categoriesRepository, transactionsRepository, contactsReadStream, parsers, parseCSV, transactions, categories, existingCategories, existingCategoriesTitles, addCategoryTitles, newCategories, finalCategories, createdTransactions;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        existingCategoriesTitles = existingCategories.map(function (category) { return category.title; });
                        addCategoryTitles = categories
                            .filter(function (category) { return !existingCategoriesTitles.includes(category); })
                    ...
                    case 3:
                        _a.sent();
                        finalCategories = __spreadArrays(newCategories, existingCategories);

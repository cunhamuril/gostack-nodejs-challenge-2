...
var TransactionsRepository = /** @class */ (function (_super) {
    ...
    TransactionsRepository.prototype.getBalance = function () {
        return __awaiter(this, void 0, void 0, function () {
            var transactions, incomes, outcomes, income, outcome, total, balance;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        incomes = transactions
                            ...
                            .map(function (transaction) { return Number(transaction.value); });
                        outcomes = transactions
                            .filter(function (transaction) { return transaction.type === 'outcome'; })
                            .map(function (transaction) { return Number(transaction.value); });
                        income = incomes.reduce(function (acc, item) { return acc + item; }, 0);
                        outcome = outcomes.reduce(function (acc, item) { return acc + item; }, 0);
